...
class Agent(Portfolio):
    def __init__(self, state_dim, balance, is_eval=False, model_name="",
                 gamma=0.99, epsilon=1.0, epsilon_min=0.1, epsilon_decay=0.999,
                 buffer_size=1000, max_memory=1000, lr=0.00001,
                 double_dqn=False, dueling_dqn=False, target_update_freq=100):
